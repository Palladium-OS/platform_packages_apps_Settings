...
public class cpu_card extends Specs_base{
    public cpu_card(@NonNull Context context) {
        super(context);
        abrir(context,null,0);
    }

    public cpu_card(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        abrir(context,attrs,0);
    }

    public cpu_card(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void abrir(Context context, AttributeSet attrs, int defStyleAttr){
        ...
        logo.setImageResource(R.drawable.ic_homepage_system_dashboard);
        ...
        if(SystemProperties.get("ro.palladium.build.status").equals("OFFICIAL")){
            ...
            card_title.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT));
             card_summary.setText(SystemProperties.get("ro.palladiumdevice.cpu"));
