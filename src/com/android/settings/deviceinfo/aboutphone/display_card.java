...
public class display_card extends Specs_base{
    public display_card(@NonNull Context context) {
        super(context);
        abrir(context,null,0);
    }

    public display_card(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        abrir(context,attrs,0);
    }

    public display_card(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void abrir(Context context, AttributeSet attrs, int defStyleAttr){
        ...
        logo.setImageResource(R.drawable.ic_about_display);
        ...
        if(SystemProperties.get("ro.palladium.build.status").equals("OFFICIAL")){
            ...
            card_summary.setText(SystemProperties.get("ro.palladiumdevice.display")+" "+SystemProperties.get("ro.palladiumdevice.displaytype"));
